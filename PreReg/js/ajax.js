...
function check(){
	if(xmlHttpRequest.readyState == 4){
		...
		str=str.trim();
		var quizid;
		var quizoption1ID="quiz"+panelNumber+"option"+1;
		var quizoption2ID="quiz"+panelNumber+"option"+2;
		var quizoption3ID="quiz"+panelNumber+"option"+3;
		var quizoption4ID="quiz"+panelNumber+"option"+4;
		quizid ="quiz"+panelNumber;
		//alert("quizid: "+quizid);
		...
		if(attempts<2)
		{
			...
			if(str == "true")
			{
				...
				if((panelNumber != 3) || (panelNumber!=6)){
					document.getElementById(quizoption1ID).disabled=true;
					document.getElementById(quizoption2ID).disabled=true;
					document.getElementById(quizoption3ID).disabled=true;
					document.getElementById(quizoption4ID).disabled=true;
				}
				if((panelNumber == 3) || (panelNumber == 6)){
					document.getElementById(quizoption1ID).disabled=true;
					document.getElementById(quizoption2ID).disabled=true;
				...
				//document.getElementById(quizid).style.zIndex = -10000;
				//alert("z-index: "+document.getElementById(quizid).style.zIndex);
				attempts=3;
				//getQuizscore();
				//movenextpanel();
			}
		...
		if(attempts==2){
			...
			if(str == "false")
			{
				document.getElementById(id).innerHTML = "Incorrect!"+"<br>"+"<span>Final attempt--consider reviewing the previous section, before moving to the next level.</span>";
				document.getElementById("next").style.display="block";
				completePanelUpdate(panelNumber,attempts,"false");
				document.getElementById("next").disabled="block";
				if((panelNumber != 3) || (panelNumber!=6)){
					document.getElementById(quizoption1ID).disabled=true;
					document.getElementById(quizoption2ID).disabled=true;
					document.getElementById(quizoption3ID).disabled=true;
